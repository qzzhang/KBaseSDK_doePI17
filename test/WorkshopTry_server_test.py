...
from WorkshopTry.WorkshopTryImpl import WorkshopTry
from WorkshopTry.WorkshopTryServer import MethodContext


class WorkshopTryTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('WorkshopTry'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL, token=token)
        cls.serviceImpl = WorkshopTry(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_WorkshopTry_" + str(suffix)
